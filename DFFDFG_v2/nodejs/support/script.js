...
function tutorialshow()
    {
      $('body').append('<span class="sticky"><button type="button" id="videoclose">X</button><iframe width="560" height="315" src="https://www.youtube.com/embed/qEc3dGK6il0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></sticky>');
